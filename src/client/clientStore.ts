 ...
 * loader tree on the other generation (issue #17 on dsh-smooth-stream: a
 * top-level `require("@deepseek-ai/dsh-client-runtime/client")` took down the
 * web UI on DSH Desktop 2.0.4 / kernel 0.1.2-alpha.1).
 */
...
function pickRequire(): NodeRequire {
  ...
  throw new TypeError('dsh-pianist: no client module resolver available');
}
